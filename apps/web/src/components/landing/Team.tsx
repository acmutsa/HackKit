...
export default function Team() {
  ...
  return (
    <section
      className={`${oswald.className} flex flex-col w-full min-h-screen lg:bg-[url('/img/landing/Second_Layer_Background_large.svg')] bg-cover bg-no-repeat space-y-20 pb-20 md:pb-48`}>
