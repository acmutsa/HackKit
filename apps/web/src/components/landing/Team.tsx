...
let team: Array<Person> = [
	...
	createPerson("Nathan", "Zuniga", director, "https://www.linkedin.com/in/nathanzuniga/", "", ""),
	createPerson("Mei", "Sullum", director, "https://www.linkedin.com/in/meirasullum/", "", ""),
	createPerson(
		"Liam",
		"Murray",
		`${tech}\u00A0/\u00A0${logistics}`,
	...
	createPerson("Diem", "Bui", pr, "https://www.linkedin.com/in/diembui1910/", "", ""),
	createPerson("Natasha", "Blussick", pr, "https://www.linkedin.com/in/natasha-blussick/", "", ""),
	createPerson(
		"Alejandro",
		"Mugica",
		logistics,
	...
	createPerson("Paolo", "Lay", logistics, "https://www.linkedin.com/in/paolo-lay/", "", ""),
	createPerson(
		"Alessandro",
		"Espinosa",
		experience,
...
export default function Team() {
	return (
		<section
			className={`${oswald.className} flex flex-col justify-center w-full min-h-screen bg-[rgb(91,130,73)] space-y-20 pb-48`}
		>
			<div className="flex w-full justify-start items-start max-w-5xl mx-auto">
				<h1 className="pt-10 text-2xl sm:text-3xl md:text-4xl lg:text-8xl font-bold font-oswald italic text-hackathon">
					Meet The Team
				</h1>
			</div>
