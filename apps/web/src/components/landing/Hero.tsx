...
export default function Hero() {
  ...
  const grass_back_1 = useTransform(springyScrollProg, [0, 1], ["0%", "10%"]);
    ...
    <section
      ...
      className="min-h-screen w-screen overflow-x-hidden overflow-y-hidden relative bg-gradient-to-t from-[#E3E165] via-[#CCD2AD] to-[#CCD2AD]">
      <motion.div
        style={{ y: sky }}
        className="absolute h-full w-full bg-gradient-to-t from-[#E3E165] via-[#CCD2AD] to-[#CCD2AD]"></motion.div>
      {/* <motion.div style={{ y: grass_back_5 }} className="absolute w-full h-full">
				<Volcano />
			</motion.div> */}
      <motion.div
        style={{ y: grass_back_5 }}
      ...
      <motion.div
        style={{ y: grass_back_caveplants_2 }}
        className="absolute w-full h-full">
        <Image
