	...
	return (
		...
		<section className="w-full overflow-hidden relative pb-[30vw] sm:pb-[0]">
			<div className="absolute w-full sm:w-[85%] md:w-[80%] lg:w-[75%] sm:left-4 md:left-8 lg:left-12 relative">
				...
				<div className="absolute w-[15%] top-[32.5%] left-[15%] rotate-[12deg] sm:top-[31%] font-medium">
			...
			<div className="absolute hover:scale-110 w-[35%] sm:w-[18%] lg:w-[25%] top-[68%] left-[1%] sm:left-[82%] sm:top-[43%] md:left-[80%] lg:left-[75%] rotate-3 sm:-rotate-3">
				<img 
					...
					className="w-full h-auto"
				/>
				<a href="\register" className="absolute top-[20%] right-[30%] sm:top-[18%] lg:right-[30%] sm:right-[25%] text-red-800 text-[4.5vw] sm:text-[2.5vw] lg:text-[2.75vw] font-medium">Register</a>
			</div>
			<div className="absolute w-[35%] sm:w-[12.5%] lg:w-[17.5%] left-[36%] top-[73.5%] sm:top-[55%] sm:left-[83%] lg:top-[60%] lg:left-[77.5%]">
				<img 
					src="/img/assets/blank-tape-stickers3.svg" 
					alt=""
					className="w-full h-auto"
				/>
				<h1 className="absolute top-[20%] left-[17%] -rotate-[5deg] text-[3.5vw] sm:text-[1.5vw] lg:text-[1.75vw] lg:top[23%] lg:left-[20%] font-medium">Help Wanted</h1>
			...
			<div className="absolute hover:scale-110 w-[25%] left-[22%] top-[83%] sm:w-[12.5%] sm:left-[80%] sm:top-[65%] lg:top-[75%] lg:left-[72.5%] lg:w-[17.5%]"> 
				<img 
					src="/img/assets/blank-tape-stickers1.svg" 
					alt=""
					className="w-full h-auto"
				/>
				<h1 className="absolute top-[20%] left-[32.5%] text-[2.75vw] sm:text-[1.75vw] sm:top-[10%] sm:left-[25%] font-medium lg:text-[2.25vw] lg:top-[12.5%]">Mentors</h1>
			</div>
			<div className="absolute hover:scale-110 w-[25%] left-[54.5%] top-[83%] sm:w-[12.5%] sm:left-[85%] sm:top-[71%] lg:top-[83.5%] lg:left-[80%] lg:w-[17.5%]">
				<img 
					src="/img/assets/blank-tape-stickers1.svg" 
					alt=""
					className="w-full h-auto"
				/>
				<h1 className="absolute top-[20%] left-[32.5%] text-[2.75vw] sm:text-[1.75vw] sm:top-[10%] sm:left-[27.5%] font-medium lg:text-[2.25vw] lg:left-[30%] lg:top-[12.5%]">Judges</h1>
			</div>
			<div className="absolute hover:scale-110 w-[25%] left-[37%] top-[90%] sm:w-[12.5%] sm:left-[80%] sm:top-[77%] lg:top-[92%] lg:left-[72.5%] lg:w-[17.5%]">
				<img 
					src="/img/assets/blank-tape-stickers1.svg" 
					alt=""
					className="w-full h-auto"
				/>
				<h1 className="absolute top-[20%] left-[27.5%] text-[2.75vw] sm:text-[1.75vw] sm:top-[10%] sm:left-[17.5%] font-medium lg:text-[2.25vw] lg:top-[12.5%] lg:left-[20%]">Volunteers</h1>
			</div>
