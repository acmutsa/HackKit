...
export default {
  ...
  days: {
    Saturday: new Date(2024, 1, 21),
    Sunday: new Date(2024, 1, 21),
  },
  ...
  startDate: new Date(new Date(2024, 1, 21).setHours(20, 7)),
  hackStartTime: new Date(new Date(2024, 1, 21).setHours(20, 8)),
  hackEndTime: new Date(new Date(2024, 1, 21).setHours(20, 9)),
