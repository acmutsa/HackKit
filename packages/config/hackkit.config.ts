...
const discordVerificationStatus = ["pending", "expired", "accepted", "rejected"] as const;
...
export default c;
export { defaultTheme, bucketResumeBaseUploadUrl, perms, discordInviteStatus, ticketStatus, discordVerificationStatus, publicRoutes };
